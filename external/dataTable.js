const DataTable = (function() {
	...
	class ActionsComponent extends HTMLElement {
		...
		render() {
			...
			this.innerHTML = 	`<div class="actions-container" >
	...
	// class for the data table web component
	class DataTableComponent extends HTMLElement {
		...
		render() {
			...
			this.shadowRoot.innerHTML = `<div class="data-table-container" >
									<link rel="stylesheet" type="text/css" href="/external/dataTable.css">
